                ...
                <div className="px-4 py-1">
                    ...
                    >
                        <div className="flex items-center gap-1">
                            ...
                            <span className="text-primary hover:text-primary font-semibold">
                                Invitation pending
                            </span>
                        </div>
                    ...
                    {isPendingOpen &&
                        projects.pending_projects.length > 0 &&
                        projects.pending_projects.map((project) => (
                            <div
                                key={project.id}
                                className="flex items-center justify-between bg-bgSecondary rounded-md px-4 py-1 my-2"
                            >
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    >
                                        <CheckIcon
                                            ...
                                            className="w-7 h-7 p-1 text-secondary rounded-md cursor-pointer hover:bg-bgSecondary"
                                        />
                                    </Tooltip>
                                    <Tooltip
                                    ...
                                    >
                                        <XMarkIcon
                                            ...
                                            className="w-7 h-7 p-1 text-red-600 rounded-md cursor-pointer hover:bg-bgSecondary"
                                        />
                                    </Tooltip>
                                </div>
                            </div>
